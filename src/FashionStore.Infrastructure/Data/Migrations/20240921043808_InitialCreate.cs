    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ColorPs_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DressStylePs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DressStylePs_DressStyles_DressStyleId",
                        column: x => x.DressStyleId,
                        principalTable: "DressStyles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DressStylePs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OutstandingId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutPs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutPs_Outstandings_OutstandingId",
                        column: x => x.OutstandingId,
                        principalTable: "Outstandings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutPs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SizePs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SizePs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SizePs_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartPs_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartPs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotions_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartPs_CartId",
                table: "CartPs",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_CartPs_ProductId",
                table: "CartPs",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DressStylePs_DressStyleId",
                table: "DressStylePs",
                column: "DressStyleId");

            migrationBuilder.CreateIndex(
                name: "IX_DressStylePs_ProductId",
                table: "DressStylePs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_OutPs_OutstandingId",
                table: "OutPs",
                column: "OutstandingId");

            migrationBuilder.CreateIndex(
                name: "IX_OutPs_ProductId",
                table: "OutPs",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SizePs_ProductId",
                table: "SizePs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SizePs_SizeId",
                table: "SizePs",
                column: "SizeId");
